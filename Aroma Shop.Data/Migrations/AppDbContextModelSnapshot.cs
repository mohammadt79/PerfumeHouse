...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Aroma_Shop.Domain.Models.BlogModels.Blog", b =>
                {
                    ...
                    b.Property<int?>("BlogImageImageId")
                        .HasColumnType("int");
                    ...
                    b.Property<string>("BuilderUserId")
            ...
            modelBuilder.Entity("Aroma_Shop.Domain.Models.BlogModels.BlogCategory", b =>
                {
                    ...
                    b.Property<int?>("ParentBlogCategoryBlogCategoryId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ParentBlogCategoryBlogCategoryId");
            ...
            modelBuilder.Entity("Aroma_Shop.Domain.Models.MediaModels.Banner", b =>
                {
                    ...
                    b.Property<int?>("BannerImageImageId")
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("IsPrimaryBanner")
                        .HasColumnType("bit");

                    b.HasKey("BannerId");

                    b.HasIndex("BannerImageImageId");
            ...
            modelBuilder.Entity("Aroma_Shop.Domain.Models.MediaModels.Newsletter", b =>
                {
            ...
            modelBuilder.Entity("Aroma_Shop.Domain.Models.BlogModels.Blog", b =>
                {
                    b.HasOne("Aroma_Shop.Domain.Models.FileModels.Image", "BlogImage")
                        .WithMany()
                        .HasForeignKey("BlogImageImageId");

                    b.HasOne("Aroma_Shop.Domain.Models.CustomIdentityModels.CustomIdentityUser", "BuilderUser")
                        .WithMany()
                        .HasForeignKey("BuilderUserId");

                    b.Navigation("BlogImage");

                    b.Navigation("BuilderUser");
                });

            modelBuilder.Entity("Aroma_Shop.Domain.Models.BlogModels.BlogCategory", b =>
                {
                    b.HasOne("Aroma_Shop.Domain.Models.BlogModels.Blog", "Blogs")
                        .WithMany("BlogCategories")
                        .HasForeignKey("BlogsBlogId");

                    b.HasOne("Aroma_Shop.Domain.Models.BlogModels.BlogCategory", "ParentBlogCategory")
                        .WithMany("ChildrenBlogCategory")
                        .HasForeignKey("ParentBlogCategoryBlogCategoryId");
            ...
            modelBuilder.Entity("Aroma_Shop.Domain.Models.MediaModels.Banner", b =>
                {
                    b.HasOne("Aroma_Shop.Domain.Models.FileModels.Image", "BannerImage")
                        .WithMany()
                        .HasForeignKey("BannerImageImageId");
            ...
            modelBuilder.Entity("Aroma_Shop.Domain.Models.MediaModels.Comment", b =>
                {
                    b.HasOne("Aroma_Shop.Domain.Models.BlogModels.Blog", null)
                        .WithMany("Comments")
            ...
            modelBuilder.Entity("Aroma_Shop.Domain.Models.BlogModels.BlogCategory", b =>
                {
                    b.Navigation("ChildrenBlogCategory");
                });
